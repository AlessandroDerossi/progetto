...
class SimpleFirestorePopulator:
    ...
    def create_session(self, user_id, session_date):
        ...
        try:
            ...
            avg_intensity = round(random.uniform(90, 150), 2)  # Intensità da 90 a 150
        ...
        try:
            ...
            for i in range(punch_count):
                ...
                acceleration_data = {
                    ...
                    'acceleration_x': round(random.uniform(-150.0, 150.0), 3),  # Range più ampio
                    'acceleration_y': round(random.uniform(-150.0, 150.0), 3),
                    'acceleration_z': round(random.uniform(-150.0, 150.0), 3)
                }
